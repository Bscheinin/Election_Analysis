...
total_votes=0
#Assign a variable for candidate name and votes
candidate_options=[]
candidate_votes={}
#Track winning candidate,count and winning percentage
winning_candidate=""
winning_count=0
winning_percent=0
...
with open (file_to_save,"w") as txt_file: 
    #After opening the file, print the total votes to the terminal.       
    election_results = (
    f"\nElection Results\n"
    f"---------------------\n"
    ...
    #Save the final vote total to the text file.
    txt_file.write(election_results)
    for candidate_name in candidate_votes:
        #Retrieve the vote count and percentage of votes per candidate
        votes = candidate_votes[candidate_name]
        vote_percentage=(float(votes)/float(total_votes)*100)
        candidate_results = (f"{candidate_name}: {vote_percentage:.1f}% ({votes:,})\n")
        #Print each candidates name, vote percentage and count to the terminal.
